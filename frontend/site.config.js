...
const siteConfig = {
  ...
  valueProps: [
    ...
    {
      title:       'Runs Your Marketing Campaign',
      description: 'AI-driven ad campaigns, content creation, and automated outreach that find and attract clients on autopilot.',
      highlight:   'vs. Hiring Agencies',
    },
    {
      title:       'One Dashboard, Everything',
      description: 'Use the Admin to build and manage your website, and your Dashboard to track sales, run marketing, and grow your business.',
  ...
  features: [
    ...
    {
      title:       'Templates',
      description: 'Browse 16 ready-made, high-converting website templates built for solo founders',
      preview:     'Browse 16 ready-made templates',
      link:        '/templates',
      status:      'Available',
    },
  ],
