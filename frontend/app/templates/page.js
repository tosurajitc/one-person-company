...
const TEMPLATES = [
  ...
  { slug: 'study-abroad-consultant',   name: 'Education & Migration Consultant',          description: 'Credential showcase, visa & course guidance services, consultation booking and student success stories.',                              theme: 'Warm',         accent: '#78350f', tag: 'Earthy Brown + Linen',             status: 'live',         banner: '/templates/gallery/education-migration.png' },
  ...
  { slug: 'tax-insurance',         name: 'Tax Advisors, Accountants & Insurance Advisors', description: 'Authority-driven, compliance credentials front and centre, clear service tiers and appointment booking.',                       theme: 'Professional', accent: '#1e3a5f', tag: 'Navy + Gold',                    status: 'live',         banner: '/templates/gallery/consultant-advisor.png' },
  { slug: 'home-interior-vastu',   name: 'Home Interior and Vastu Consultation',      description: 'Portfolio of interior spaces, Vastu principles, design packages, before-after showcases and consultation booking.',                   theme: 'Earthy',       accent: '#92400e', tag: 'Warm Amber + Ivory',               status: 'live',        banner: '/templates/gallery/home-interior-vastu.png' },
]
