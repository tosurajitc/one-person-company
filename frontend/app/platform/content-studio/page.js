...
const AGENT_CATEGORIES = [
  ...
  {
    id: 'money',
    label: '4. Money & Compliance',
    color: 'amber',
    agents: [
      {
        id: 'cashflow',
        title: 'Budgeting & Cashflow',
        role: 'Finance & Cashflow Advisor',
        badge: null,
        icon: Wallet,
        gradient: 'from-lime-500 to-green-700',
        description: 'Monthly budgets, cashflow forecasts, break-even math, and savings targets for irregular income.',
        samplePrompts: [
